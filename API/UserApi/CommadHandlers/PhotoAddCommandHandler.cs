...
{
    public class PhotoAddCommandHandler : IRequestHandler<PhotoAddCommand>
    {
        ...
        public async Task Handle(PhotoAddCommand request, CancellationToken cancellationToken)
        {
